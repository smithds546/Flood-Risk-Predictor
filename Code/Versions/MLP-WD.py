...
class MLP:
    ...
    def train(self, X, y, epochs, initial_learning_rate, final_learning_rate):
            ...
            for epoch in range(epochs):
                ...
                learning_rate = max(learning_rate, final_learning_rate)  # Limit learning rate to final_learning_rate
                
                # Apply weight decay
                self.weights_hidden_output -= weight_decay * self.weights_hidden_output * learning_rate
                self.weights_input_hidden -= weight_decay * self.weights_input_hidden * learning_rate
